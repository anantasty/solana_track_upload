          ...
          {props.tracks && props.tracks.map((track, index)=> {
            ...
            return (
              <Grid item xs={4} sm={4} md={4} key={index}>
                <Card sx={{ maxWidth: 345, margin: 'auto' , borderRadius: '10px' }}>
                  <CardMedia
                    component="img"
                    alt="green iguana"
                    height="140"
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" style={{padding: '5px', fontWeight: 'bold', fontSize: '18px'}}>
                      {track.artist}
                    </Typography>
                    <Typography variant="body2" color="text.secondary" style={{padding: '5px', fontWeight: 'bold'}}>
                      {track.cid}
                    </Typography>
                  </CardContent>
                </Card>
